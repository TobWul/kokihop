...
import EditorRecipeBlockList from "./EditorRecipeBlockList";
...
export const List = () => (
  <div style={{ maxWidth: 768 }}>
    <EditorRecipeBlockList
      ...
      updateBlockOrder={action("Update block order")}
    />
  </div>
);

// export const TextBlock = () => <EditorRecipeBlockWrapper />;
// export const TitleBlock = () => <EditorRecipeBlockWrapper />;
// export const ImageBlock = () => <EditorRecipeBlockWrapper />;
